...
namespace Abp.Configuration.Startup
{
    ...
    public static class AbpMongoDbConfigurationExtensions
    {
        ...
        /// </summary>
        public static IAbpMongoDbConfiguration AbpMongoDb(this IModuleConfigurations configurations)
        {
            return configurations.AbpConfiguration.Get<IAbpMongoDbConfiguration>();
        }
    }
}