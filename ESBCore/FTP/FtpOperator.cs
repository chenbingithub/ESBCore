...
namespace ESB.Common.FTP
{
    ...
    public class FtpOperator
    {
        ...
        public FtpOperator(Uri FtpUri, string strUserName, string strPassword)
        {
        ...
        public FtpOperator(Uri FtpUri, string strUserName, string strPassword, WebProxy objProxy)
        {
            this._Uri = new Uri(FtpUri.GetLeftPart(UriPartial.Authority));
            _DirectoryPath = FtpUri.AbsolutePath;
            if (!_DirectoryPath.EndsWith("/"))
